...
public class ReviewImgListSettingActivity extends AppCompatActivity {

    ImageView review_photo_add_btn;
    TextView reviewPhoto_total;
...
/////////////////////////////////////////////////////////////////////
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.review_img_list_setting);

        //xml 연결
        //툴바를 이 화면의 앱바로 연결
        Toolbar tb = (Toolbar) findViewById(R.id.review_lmg_list_setting_toolbar);
        ...
        TextView apptitle = findViewById(R.id.review_lmg_list_setting_toolbar_title);
        apptitle.setText("사진추가");
        ...
        //추가한 사진의 갯수 mapping
        reviewPhoto_total = findViewById(R.id.reviewPhoto_total);
...
//        reviewImgAdapter = new ReviewImgAdapter(list,ReviewImgListSettingActivity.this);
//        recyclerView.setAdapter(reviewImgAdapter);


        review_photo_add_btn = findViewById(R.id.review_photo_add_btn);
        review_photo_add_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ReviewImgListSettingActivity.this);
...
//                startActivity(goSetting);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ReviewImgListSettingActivity.this);
                if(sharedPreferences.contains(photoMainKey)){
                builder.setTitle("[알림] 사진 저장 완료")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //임시저장소 내용 지우기
                                //reviewPhotoList.xml 포토리스트,포토갯수
                                //removeStringArrayPref(photoListKey, photoListNumKey);
                                //reviewPhotoMain.xml
    ...
    private void captureCamera(){
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {// 외장 메모리가 현재 read와 write를 할 수 있는 상태인지 확인한다
            ...
            Toast.makeText(ReviewImgListSettingActivity.this, "저장공간이 접근 불가능한 기기입니다", Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    private void galleryAddPic(){
        ...
        Toast.makeText(ReviewImgListSettingActivity.this, "사진이 앨범에 저장되었습니다.", Toast.LENGTH_SHORT).show();
    }
...
//                    if (i < clipData.getItemCount()) {
                            ...
                            reviewPhoto_total.setText(listSize);
                    ...
                    Toast.makeText(ReviewImgListSettingActivity.this, "앨범에서 선택하기를 취소하였습니다.", Toast.LENGTH_SHORT).show();
                }
                break;
            //사진찍기
...
//                        helper.attachToRecyclerView(recyclerView);
                    ...
                    Toast.makeText(ReviewImgListSettingActivity.this, "사진찍기를 취소하였습니다.", Toast.LENGTH_SHORT).show();
                }
                break;
...
//        super.onPause();
//
//        Log.d("온포즈",":"+list+ String.valueOf(list.size()));
//
//        setStringArrayPref(SETTINGS_JSON,ARRAY_NUM,list);
//
//    }
    ...
    public void onBackPressed() {
        Toast.makeText(ReviewImgListSettingActivity.this,"backButton",Toast.LENGTH_SHORT).show();
        AlertDialog.Builder builder = new AlertDialog.Builder(ReviewImgListSettingActivity.this);
        builder.setTitle("[알림] 사진 저장 미완료")
                .setMessage("추가된 사진이 저장되지 않습니다. 계속 진행하시겠습니까?")
                .setPositiveButton("계속 진행", new DialogInterface.OnClickListener() {
...
//
//            AlertDialog.Builder builder = new AlertDialog.Builder(ReviewImgListSettingActivity.this);
//            builder.setTitle("임시 저장됨")
//                    .setMessage("추가하던 내용을 불러오시겠습니까?")
//                    .setPositiveButton("네", new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialog, int which) {

                            //숫자 반영
                            int num = getStringArraySize(photoListNumKey);

                            reviewPhoto_total.setText(String.valueOf(num));

                            Log.d("온리줌 전체 리스트", ":" + list);

                            list = getStringArrayPref(photoListKey);
                            Log.d("온리쥼 리스트 불러오기", ":" + list);

                            if(list.size()==0){
                                sharedPreferences = getSharedPreferences("reviewPhotoMain",MODE_PRIVATE);
                                SharedPreferences.Editor editor = sharedPreferences.edit();
                                Log.d("메인사진 리셋","온리쥼");
                                editor.remove(photoMainKey);
                                editor.apply();
                            }else {
                                Toast.makeText(ReviewImgListSettingActivity.this, "추가된 사진이 임시저장 됩니다",Toast.LENGTH_SHORT).show();
                            }
...
//                        @Override
//                        public void onClick(DialogInterface dialog, int which) {
//                            list = resetStringArrayPref(SETTINGS_JSON, ARRAY_NUM);
//                            // 리사이클러뷰에 SimpleTextAdapter 객체 지정.
//                            reviewImgAdapter = new ReviewImgAdapter(list,ReviewImgListSettingActivity.this);
//                            recyclerView.setAdapter(reviewImgAdapter);
//
...
//            alertDialog.show();
        ...
        Log.d("온리줌",":"+list+ String.valueOf(list.size()));
        Log.d("온리줌",": 임시저장 된거 불러오기 다이얼로그?");
...
//    private ArrayList<String> resetStringArrayPref(String key, String num_key) {
//        sharedPreferences = getSharedPreferences("reviewPhotoList",MODE_PRIVATE);
//        String json = sharedPreferences.getString(key, null);
//        Log.d("저장 >> 삭제 전", ":"+json);
//        SharedPreferences.Editor editor = sharedPreferences.edit();
